...
@Component({
  selector: 'app-three-d-canvas',
  templateUrl: './three-d-canvas.component.html',
  styleUrls: ['./three-d-canvas.component.css']
})
export class ThreeDCanvasComponent implements AfterViewInit {
  /* STAGE PROPERTIES */
  ...
  @Input()
  public texture: string = '/assets/imgs/2294472375_24a3b8ef46_o.jpg';
  ...
  private startRendering() {
    ...
    let component: ThreeDCanvasComponent = this;
